  ...
  render() {
    return (
      ...
      <Accordion.Item eventKey="0">
        <Accordion.Header className="linear"> <strong>Fantasy </strong></Accordion.Header>
        <Accordion.Body>
      ...
      <Accordion.Item eventKey="1">
        <Accordion.Header><strong>Storici</strong></Accordion.Header>
        <Accordion.Body>
        <div className="container justify-content-center">
        <Row className="d-flex">
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header><strong>Horror</strong></Accordion.Header>
        <Accordion.Body>
        <div className="container justify-content-center">
        <Row className="d-flex">
      ...
      <Accordion.Item eventKey="3">
        <Accordion.Header><strong>Romantici</strong></Accordion.Header>
        <Accordion.Body>
        <div className="container justify-content-center">
        <Row className="d-flex">
      ...
      <Accordion.Item eventKey="4">
        <Accordion.Header><strong>Fantascienza </strong></Accordion.Header>
        <Accordion.Body>
        <div className="container justify-content-center">
        <Row className="d-flex">
